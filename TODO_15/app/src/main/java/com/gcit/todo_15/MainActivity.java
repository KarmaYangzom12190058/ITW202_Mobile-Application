...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewPager view_pager = findViewById(R.id.pager);
        PagerAdapater adapater = new PagerAdapater(getSupportFragmentManager(), tabLayout.getTabCount());
        view_pager.setAdapter(adapater);
